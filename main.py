...
# For debugging, you can remove headless mode temporarily.
chrome_options.add_argument("--headless")
chrome_options.add_argument("--disable-gpu")
chrome_options.add_argument("--no-sandbox")
chrome_options.add_argument("--disable-dev-shm-usage")
# Use a mobile user agent similar to Kiwi's
...
# === Step 4: Load the Full Mini-App UI Page ===
# Replace with the actual mini-app URL from your Kiwi session.
full_url = "https://t.me/gold_eagle_coin_bot/main?startapp=r_gTGFKMkFC5"
driver.get(full_url)
time.sleep(5)  # Allow time for the page to load

# === Step 5: Inject Telegram Initialization Data ===
# Use the exact values from your Kiwi session.
init_params = {
...
# === Step 7: Run Tapping Cycles ===
# For each cycle, send a batch of 200 tap requests, then sleep for 3 minutes.
cycles = 3  # Adjust number of cycles as needed.
